# Continue until a non-positive value is entered
condition = True
while condition:
    firstSide = int(input("Enter 1nd side: "))
    ...
    # Triangle Inequality Theorem
        ...
        triangleSides = []
        triangleSides.append(firstSide)
        triangleSides.append(secondSide)
        triangleSides.append(thirdSide)
        triangleSides.sort()
